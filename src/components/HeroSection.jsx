        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <motion.div
            ...
            <div className="flex flex-wrap gap-4 pt-4 justify-center md:justify-start">
              <a
                href="#work"
                className="w-36 justify-center inline-flex items-center px-7 py-3 rounded-lg bg-[hsl(var(--secondary))] text-white font-medium text-sm hover:bg-turquoise transition-all duration-300 hover:shadow-lg hover:shadow-turquoise/25 text-shadow-btn">
                See my work
              </a>
              <a
                href="#contact" className="w-36 justify-center inline-flex items-center px-7 py-3 rounded-lg bg-purple text-white font-medium text-sm hover:bg-purple/90 hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-purple/25 text-shadow-btn">Talk to me
